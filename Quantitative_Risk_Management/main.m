...
z_99=norminv(.99,0,1); %Inverse normal cumulative distribution function giving the 99% quantile
fprintf('------- Gaussian VaR -------\n')
GaussianVaR = -(a'* mu -(a'*SIGMA*a)^(1/2)*z_99)
%% VaR - Non parametric
...
SensitivitiesGaussianVaR = -mu + SIGMA * a/(a'*SIGMA*a)^(1/2)*z_99 
